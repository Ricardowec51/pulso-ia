...
def generate():
    ...
    indice = [
        ("📊", "Resumen Ejecutivo", "Economía de agentes de IA: el punto de inflexión de mayo 2026"),
        ("📰", "Noticias Destacadas", "AIFI26 · Ecuador Ley IA · Alteryx Agent Studio"),
        ("🤖", "Modelos Destacados", "Gemini 3.5 Flash · GPT-5.5 vs Claude Opus 4.7 Thinking"),
        ("📈", "Tendencias del Mercado", "Fintechs mexicanas · Regulación LATAM 2026-2030"),
    ...
    todos = HASHTAGS_FIJOS + HASHTAGS_DINAMICOS
    ...
    # ── Guardar ───────────────────────────────────────────────────────────────
    out = OUTPUT_DIR / f"PULSO_a_la_IA_Edicion_{EDITION}.docx"
    doc.save(out)
    patch_headers_xml(out)
    print(f"✓ Generado: {out}")
    return out


def patch_headers_xml(docx_path):
